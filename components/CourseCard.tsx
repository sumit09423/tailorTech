  ...
  return (
    <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow border border-gray-200 overflow-hidden">
      ...
      {course.image && !imageError && (
        <div className="relative w-full h-48 bg-gradient-to-br from-[#00bfff]/20 to-[#e91e63]/20">
          <Image
            src={course.image}
            alt={course.title}
            fill
      ...
      {course.image && imageError && (
        <div className="w-full h-48 bg-gradient-to-br from-[#00bfff]/20 to-[#e91e63]/20 flex items-center justify-center">
