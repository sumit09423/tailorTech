...
export const COURSES = [
  ...
  {
    id: "data-backend-foundations",
    cat: "data",
    badge: "New",
    emoji: "📘",
    banner: "linear-gradient(135deg,#3F3D89,#8B5A9E,#E91E63)",
    title: "Data & Backend Foundations",
    desc: "Master SQL, Python, ETL, Linux & warehousing basics — build the technical base to start in data and backend roles.",
    duration: "4 weeks",
    mode: "Live & Online",
    focus: "SQL, Python, ETL, Linux & Git, data warehousing concepts",
    lessons: "4 weeks",
    rating: "5.0",
    price: "—",
    original: "",
    currency: "",
    priceLabel: "Contact for enrollment",
    earlyBird: null,
    tags: ["Live & Online", "4 Weeks"],
    kind: "program",
    longDesc:
      "This 4-week live online program is the first milestone on your data and backend journey. It expands each module with practical outcomes, exercises, and weekly deliverables. You’ll build confidence with SQL, connect analytical SQL to Python for ETL-style workflows, process files and APIs in Python, then tie it together with Linux, Git, warehouse modeling, and core ETL concepts — so you understand how data moves from source to curated tables in real teams.",
    whatItCovers: [
      {
        title: "Week 1 — SQL Foundations",
        bullets: [
          "Database basics; tables, rows, and columns",
          "SELECT, WHERE, ORDER BY, LIMIT, DISTINCT",
          "GROUP BY, HAVING, aggregates",
          "INNER, LEFT, RIGHT, FULL, and self joins — hands-on reporting queries",
          "Outcome: write core SQL for analytics, reporting, and simple pipeline validation",
        ],
      },
      {
        title: "Week 2 — Advanced SQL + Python Basics",
        bullets: [
          "Subqueries, CTEs, window functions, ROW_NUMBER / RANK / DENSE_RANK",
          "SQL interview-style patterns",
          "Python variables, types, conditions, loops, functions",
          "Lists, tuples, dictionaries, sets — beginner exercises",
          "Outcome: analytical SQL plus Python building blocks used in ETL scripts",
        ],
      },
      {
        title: "Week 3 — Python for Data Processing",
        bullets: [
          "File handling, CSV and JSON, exception handling, modules",
          "OOP basics, calling APIs, reading responses",
          "Data cleaning routines and reusable ETL script structure",
          "Outcome: scripts that extract, clean, and transform from files or APIs",
        ],
      },
      {
        title: "Week 4 — Linux, Warehousing & ETL",
        bullets: [
          "Linux navigation, permissions, shell commands, Bash and cron basics",
          "Git commits, branching, merge basics",
          "OLTP vs OLAP, fact and dimension tables, star and snowflake, SCD Type 1 & 2",
          "ETL vs ELT, CDC, idempotency, backfills, medallion-style flow",
          "Outcome: comfort with beginner SQL + Python data handling, Linux, warehouse concepts, and core ETL terminology",
        ],
      },
    ],
    whatYouGet: [
      "4-week live online curriculum with weekly deliverables",
      "Daily drills, join practice, notebooks, labs, and mini assignments",
      "Structured path aligned with the official TailorTech curriculum PDF",
      "Limited seats — ask about the next cohort on WhatsApp",
    ],
    programDetails: { batchSize: "Limited seats · Live & Online · 4 weeks" },
  },
  {
  ...
  "data-backend-foundations": [
    {
      ...
      meta: "Week 1",
      lessons: [
        "Database basics, SELECT & filtering|Live",
        "GROUP BY, aggregates, joins|Live",
        "Reporting queries & join practice set|Lab",
        "🛠 Mini assignment — multiple tables|Lab",
      ],
    },
    {
      num: "02",
      title: "Advanced SQL + Python Basics",
      meta: "Week 2",
      lessons: [
        "CTEs, window functions, SQL patterns|Live",
        "Python variables, control flow, collections|Live",
        "Advanced SQL worksheet|Lab",
        "🛠 Mixed SQL + Python assessment|Lab",
      ],
    },
    {
      num: "03",
      ...
      meta: "Week 3",
      lessons: [
        "CSV, JSON, files & exceptions|Live",
        "APIs, cleaning, ETL-shaped scripts|Live",
        "CSV → cleaned output|Lab",
        "🛠 Reusable transformation script|Lab",
      ],
    },
    {
      num: "04",
      title: "Linux, Warehousing & ETL",
      meta: "Week 4",
      lessons: [
        "Linux shell & Git workflow basics|Live",
        "Warehouse modeling & star/snowflake|Live",
        "ETL/ELT, CDC, idempotency, medallion intro|Live",
        "🛠 Terminal lab & mini ETL design case|Lab",
      ],
    },
  ],
  "mock-interviews": [
...
export const BATCHES = [
  ...
  {
    label: "Data & Backend Foundations",
    name: "4-week cohort",
    color: "#B565D8",
    start: "Enquire on WhatsApp",
    time: "4 weeks · Live & Online",
    mode: "Live & Online",
    seats: null,
    status: "open",
    courseId: "data-backend-foundations",
  },
  {
